...
export default function InputBox() {
  ...
  return (
    <div className="border-t border-white/50 bg-white/80 backdrop-blur-lg shadow-[0_-10px_40px_rgba(15,23,42,0.08)]">
      <div className="w-full max-w-[90%] mx-auto px-4 py-6">
        <div className="flex flex-col md:flex-row md:items-end gap-3">
          ...
          <div className="flex items-center gap-3 justify-center md:justify-end self-end">
            <button
              ...
              disabled={isDisabled}
              className={cn(
                'flex items-center justify-center w-14 h-14 rounded-full bg-primary text-white border-2 border-gray-800 shadow-lg transition transform hover:scale-105',
                'disabled:bg-gray-300 disabled:cursor-not-allowed disabled:hover:scale-100 disabled:border-gray-400',
            ...
            <button
              ...
              onClick={resetChat}
              className={cn(
                'flex items-center justify-center w-14 h-14 rounded-full border-2 border-gray-800 bg-white/90 text-primary shadow-md transition hover:bg-primary hover:text-white hover:border-primary focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2'
              )}
